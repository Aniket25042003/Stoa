...
const field =
  "mt-5 block w-full rounded-lg border border-mist bg-cream px-3 py-2.5 text-sm text-ink placeholder:text-ink/40 focus:border-slate focus:outline-none focus:ring-2 focus:ring-slate/25";
const label = "text-xs font-medium uppercase tracking-wide text-slate";
    ...
    <form onSubmit={onSubmit} className="space-y-0">
      ...
      <div>
        ...
        <input
          ...
          placeholder="e.g. seed-stage B2B SaaS founders"
        />
      </div>
      <div>
        <label htmlFor="geo" className={label}>
          Geography
        </label>
        <input
          id="geo"
      ...
      <div>
        ...
        <input id="competitors" className={field} value={knownCompetitors} onChange={(e) => setKnownCompetitors(e.target.value)} />
      </div>
      <div>
        ...
        <input
          ...
          placeholder="e.g. PLG SaaS, enterprise sales, marketplace"
        />
      </div>
      <div>
        ...
        <input
          ...
          placeholder="e.g. pre-launch, beta, seed"
        />
      </div>
      <div>
      ...
      <div>
        ...
        <textarea id="constraints" rows={4} className={field} value={constraints} onChange={(e) => setConstraints(e.target.value)} />
      </div>
      {err ? <p className="mt-4 text-sm text-ink">{err}</p> : null}
      <div className="mt-8">
        <button
          type="submit"
          disabled={loading}
          className="rounded-lg bg-slate px-5 py-2.5 text-sm font-semibold text-cream shadow-glow transition-opacity hover:opacity-90 disabled:opacity-50"
        >
